    ...
    function getHtml(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i].children !== undefined && data[i].children !== null && data[i].children.length > 0) {
                ...
                for (var j = 0; j < data[i].children.length; j++) {
                    ...
                    if (data[i].children[j].children !== undefined && data[i].children[j].children !== null && data[i].children[j].children.length > 0) {
                        ...
                        for (var k = 0; k < grandsonNodes.length; k++) {
                            ulHtml += '<dd>';
                            ulHtml += '<a href="javascript:;" onclick="iframeChg(\''+grandsonNodes[k].href +'\')">' + grandsonNodes[k].title + '</a>';
                            ulHtml += '</dd>';
                        }
                        ulHtml += '</dl>';
                        ulHtml += '</dd>';
                        ...
                        ulHtml += '<dd>';
                        ulHtml += '<a href="javascript:;" onclick="iframeChg(\''+data[i].children[j].href+'\')">' + data[i].children[j].title;
                        ulHtml += '</a>';
                        ulHtml += '</dd>';
                    }
                ...
                ulHtml += '<a href="javascript:;" onclick="iframeChg(\'' + data[i].href + '\')"' + dataUrl + '>';
